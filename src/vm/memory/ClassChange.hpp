...
public:
	...
	struct KlassOopDescriptor *new_class_from(struct KlassOopDescriptor *old_klass, struct KlassOopDescriptor *new_super_klass, struct MixinOopDescriptor *new_mixin, Klass::Format new_format,
	                                          struct MixinOopDescriptor *old_mixin);

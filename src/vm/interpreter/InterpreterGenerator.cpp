...
void InterpreterGenerator::generate_method_entry_code() {
	...
	_macroAssembler->call((const char *) Recompilation::methodOop_invocation_counter_overflow,
	                      RelocationInformation::RelocationType::runtime_call_type); // methodOop_invocation_counter_overflow(receiver, methodOop)

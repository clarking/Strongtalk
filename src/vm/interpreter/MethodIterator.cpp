...
//                [[fallthrough]];
			...
			case ByteCodes::Code::primitive_call_self: {
				...
				PrimitiveCallNode *node = MethodIterator::factory->new_PrimitiveCallNode(_interval->method(), _interval, iter.byteCodeIndex(), iter.next_byteCodeIndex(), pdesc->has_receiver(),
				                                                                         nullptr, pdesc);
			...
			case ByteCodes::Code::primitive_call_self_failure: {
				PrimitiveDescriptor *pdesc = Primitives::lookup((primitiveFunctionType) iter.word_at(1));
				PrimitiveCallNode *node = MethodIterator::factory->new_PrimitiveCallNode(_interval->method(), _interval, iter.byteCodeIndex(), iter.next_byteCodeIndex(), pdesc->has_receiver(),
				                                                                         nullptr, pdesc, iter.word_at(1 + OOP_SIZE));
			...
			case ByteCodes::Code::primitive_call_self_lookup: {
				...
				PrimitiveCallNode *node = MethodIterator::factory->new_PrimitiveCallNode(_interval->method(), _interval, iter.byteCodeIndex(), iter.next_byteCodeIndex(),
				                                                                         iter.code() == ByteCodes::Code::primitive_call_self_lookup, name, nullptr);
			...
			case ByteCodes::Code::primitive_call_self_failure_lookup: {
				...
				st_assert(name->isSymbol(), "name must be SymbolOop");
				PrimitiveCallNode *node = MethodIterator::factory->new_PrimitiveCallNode(_interval->method(), _interval, iter.byteCodeIndex(), iter.next_byteCodeIndex(),
				                                                                         iter.code() == ByteCodes::Code::primitive_call_self_failure_lookup, name, nullptr, iter.word_at(1 + OOP_SIZE));

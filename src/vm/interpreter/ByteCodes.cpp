...
static bool actually_generated(ByteCodes::Code code) {
	return ByteCodes::is_defined(code) and (ByteCodes::send_type(code) == ByteCodes::SendType::NO_SEND or ByteCodes::send_type(code) == ByteCodes::SendType::INTERPRETED_SEND or
	                                        ByteCodes::send_type(code) == ByteCodes::SendType::PREDICTED_SEND);
}
